...
<body>
    ...
    <div class="quiz-container text-center">
        <div class="quiz-title">KUIS 4</div>
        ...
        <div class="text-start">
            ...
            <ol class="instructions">
                <li>
                    Terdapat <strong>beberapa soal pilihan ganda</strong> pada kuis ini.
        ...
        <div class="button-group d-flex justify-content-center gap-4">
            <a href="/quiz/quiz_bab4" class="btn btn-purple">MULAI</a>
            <a href="/bab_1/latihan4" class="btn btn-gray">KEMBALI</a>
        </div>
    </div>
